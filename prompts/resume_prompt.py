...
def build_resume_prompt(job_description: str, current_resume: str) -> str:
    return f"""You are an expert resume writer and ATS optimization specialist. Generate a completely new, ATS-optimized resume from the Job Description and Current Resume below.
